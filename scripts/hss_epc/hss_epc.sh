...
mkdir -p ${LTE_BASE_DIR}/config/hss
OPEN5GS_HSS_EPC_CONFIG=${LTE_BASE_DIR}/open5gs/etc/open5gs/hss.yaml
${LTE_BASE_DIR}/scripts/common/subst.sh ${LTE_BASE_DIR}/config/hss_epc/hss.yaml.in ${OPEN5GS_HSS_EPC_CONFIG}
